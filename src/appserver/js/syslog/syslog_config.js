...
//        boxM,
        rowNumber,
        {header:'日志服务器主机',		dataIndex:'host',		   align:'center',sortable:true,menuDisabled:true},
        {header:"日志服务器端口",	dataIndex:"port",       align:'center',sortable:true,menuDisabled:true}   ,
        {header:'操作标记', dataIndex:'flag', sortable:true, menuDisabled:true, renderer:show_flag}
    ]);
