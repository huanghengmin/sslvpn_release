...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/audit/syslog_config.js"></script>
</head>
...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/syslog/syslog_config.js"></script>
</head>
