...
-- 正在导出表  sslvpn.account 的数据：~5 rows (大约)
...
REPLACE INTO `account` (`id`, `user_name`, `password`, `sex`, `phone`, `created_time`, `modified_time`, `status`, `depart`, `title`, `name`, `email`, `start_ip`, `end_ip`, `start_hour`, `end_hour`, `description`, `remote_ip`, `mac`, `ip_type`) VALUES
	...
	(4, 'auditadmin', 'S8W2gMnH8VWiT9pXRMPQxA==', '男', '0571-88888888', '2012-07-03 10:19:57', '2013-05-07 19:09:34', '有效', '信息中心', '主任', '审计管理员', 'xiaom@hzih.net', '0.0.0.0', '192.168.200.254', 7, 22, '这是一个默认的审计管理员信息', NULL, NULL, 1),
	(5, 'tom', 'GVRLtHuWAlmP6QEvqadifw==', '男', '0571-88880571', '2014-04-01 15:55:00', NULL, '有效', '信息部', '主任', '李华', '33@hzih.net', '192.168.1.0', '192.168.2.255', 9, 18, '这是一个用户信息', NULL, '', 1);
...
-- 正在导出表  sslvpn.account_role 的数据：~5 rows (大约)
...
-- 正在导出表  sslvpn.business_log 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `business_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `business_log` ENABLE KEYS */;


-- 导出  表 sslvpn.ca_manager 结构
DROP TABLE IF EXISTS `ca_manager`;
CREATE TABLE IF NOT EXISTS `ca_manager` (
  `id` int(11) NOT NULL,
  `ca_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `ca_file` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
  `cn` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `notbefore` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `notafter` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- 正在导出表  sslvpn.ca_manager 的数据：1 rows
/*!40000 ALTER TABLE `ca_manager` DISABLE KEYS */;
REPLACE INTO `ca_manager` (`id`, `ca_name`, `ca_file`, `status`, `cn`, `notbefore`, `notafter`) VALUES
	(1, 'CAA.cer', '/usr/app/vpn/ssl/ca/75.pem', 1, 'CAA', '2025年04日14日10时44分58秒', '2015年04日17日10时44分58秒');
/*!40000 ALTER TABLE `ca_manager` ENABLE KEYS */;


-- 导出  表 sslvpn.client_dns 结构
DROP TABLE IF EXISTS `client_dns`;
...
-- 正在导出表  sslvpn.client_dns 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `client_dns` DISABLE KEYS */;
/*!40000 ALTER TABLE `client_dns` ENABLE KEYS */;


-- 导出  表 sslvpn.client_route 结构
DROP TABLE IF EXISTS `client_route`;
...
-- 正在导出表  sslvpn.client_route 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `client_route` DISABLE KEYS */;
/*!40000 ALTER TABLE `client_route` ENABLE KEYS */;


-- 导出  表 sslvpn.district 结构
...
-- 正在导出表  sslvpn.district 的数据：~4,066 rows (大约)
/*!40000 ALTER TABLE `district` DISABLE KEYS */;
REPLACE INTO `district` (`district_id`, `district_name`) VALUES
	(10000, '公安部'),
	(17000, '公安部消防局'),
	(110000, '北京市'),
	(110101, '北京市市辖区东城区'),
	...
	(654100, '新疆维吾尔自治区伊犁地区'),
	(654101, '新疆维吾尔自治区伊犁地区伊宁市'),
	(654121, '新疆维吾尔自治区伊犁地区伊宁县'),
	(654122, '新疆维吾尔自治区伊犁地区察布查尔锡伯自治县'),
	(654123, '新疆维吾尔自治区伊犁地区霍城县'),
	(654124, '新疆维吾尔自治区伊犁地区巩留县'),
	(654125, '新疆维吾尔自治区伊犁地区新源县'),
	(654126, '新疆维吾尔自治区伊犁地区昭苏县'),
	(654127, '新疆维吾尔自治区伊犁地区特克斯县'),
	(654128, '新疆维吾尔自治区伊犁地区尼勒克县'),
	(654200, '新疆维吾尔自治区塔城地区'),
	...
	(659002, '新疆维吾尔自治区省直辖行政单位阿拉尔市'),
	(659003, '新疆维吾尔自治区省直辖行政单位图木舒克市'),
	(659004, '新疆维吾尔自治区省直辖行政单位五家渠市'),
	(660000, '建设兵团');
/*!40000 ALTER TABLE `district` ENABLE KEYS */;


-- 导出  表 sslvpn.file_serials 结构
DROP TABLE IF EXISTS `file_serials`;
CREATE TABLE IF NOT EXISTS `file_serials` (
  `id` int(10) NOT NULL DEFAULT '1',
  `ca_serial` int(10) NOT NULL DEFAULT '0',
  `server_serial` int(10) NOT NULL DEFAULT '0',
  `key_serial` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ca_serial` (`ca_serial`),
  KEY `server_serial` (`server_serial`),
  KEY `key_serial` (`key_serial`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- 正在导出表  sslvpn.file_serials 的数据：1 rows
/*!40000 ALTER TABLE `file_serials` DISABLE KEYS */;
REPLACE INTO `file_serials` (`id`, `ca_serial`, `server_serial`, `key_serial`) VALUES
	(1, 76, 5, 3);
/*!40000 ALTER TABLE `file_serials` ENABLE KEYS */;
...
-- 正在导出表  sslvpn.groups 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `groups` ENABLE KEYS */;


-- 导出  表 sslvpn.group_nets 结构
DROP TABLE IF EXISTS `group_nets`;
CREATE TABLE IF NOT EXISTS `group_nets` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `net` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `net_mask` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `net` (`net`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- 正在导出表  sslvpn.group_nets 的数据：~5 rows (大约)
/*!40000 ALTER TABLE `group_nets` DISABLE KEYS */;
REPLACE INTO `group_nets` (`id`, `net`, `net_mask`) VALUES
	(2, '192.168.4.0', '255.255.255.0'),
	(3, '192.168.3.0', '255.255.255.0'),
	(4, '192.168.1.0', '255.255.255.0'),
	(6, '192.168.5.0', '255.255.255.0'),
	(7, '192.168.6.0', '255.255.255.0');
/*!40000 ALTER TABLE `group_nets` ENABLE KEYS */;


-- 导出  表 sslvpn.group_private_nets 结构
DROP TABLE IF EXISTS `group_private_nets`;
CREATE TABLE IF NOT EXISTS `group_private_nets` (
  `group_id` int(11) NOT NULL DEFAULT '0',
  `private_net_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`group_id`,`private_net_id`),
  KEY `FK712C517245507B73` (`private_net_id`),
  KEY `FK712C51724A432DCF` (`group_id`),
  KEY `FK712C51726D621AC7` (`private_net_id`),
  KEY `FK712C5172BD119723` (`group_id`),
  CONSTRAINT `FK712C51726D621AC7` FOREIGN KEY (`private_net_id`) REFERENCES `private_nets` (`id`),
  CONSTRAINT `FK712C5172BD119723` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
  CONSTRAINT `FK_group_private_nets_groups` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
  CONSTRAINT `FK_group_private_nets_private_nets` FOREIGN KEY (`private_net_id`) REFERENCES `private_nets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  sslvpn.group_private_nets 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `group_private_nets` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_private_nets` ENABLE KEYS */;


-- 导出  表 sslvpn.key_manager 结构
DROP TABLE IF EXISTS `key_manager`;
CREATE TABLE IF NOT EXISTS `key_manager` (
  `id` int(10) NOT NULL,
  `key_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `key_file` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- 正在导出表  sslvpn.key_manager 的数据：1 rows
/*!40000 ALTER TABLE `key_manager` DISABLE KEYS */;
REPLACE INTO `key_manager` (`id`, `key_name`, `key_file`) VALUES
	(1, 'server.key', '/usr/app/vpn/ssl/key/2.key');
/*!40000 ALTER TABLE `key_manager` ENABLE KEYS */;
...
-- 正在导出表  sslvpn.permission 的数据：~41 rows (大约)
...
REPLACE INTO `permission` (`ID`, `CODE`, `NAME`, `DESCRIPTION`, `PARENT_ID`, `SEQ`) VALUES
	...
	(172, 'SECOND_SYSLOG', '日志服务器', NULL, 170, 2),
	(173, 'SECOND_JCPZ', '监测服务器', NULL, 170, 3),
	(174, 'SECOND_STRATEGY', '客户端策略', NULL, 170, 4),
	(175, 'SECOND_CONTROL', '访问控制', NULL, 170, 5),
...
-- 导出  表 sslvpn.pkcs 结构
DROP TABLE IF EXISTS `pkcs`;
CREATE TABLE IF NOT EXISTS `pkcs` (
  `id` int(10) NOT NULL,
  `pkcs_crt` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `pkcs_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `cn` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `notbefore` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `notafter` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- 正在导出表  sslvpn.pkcs 的数据：1 rows
/*!40000 ALTER TABLE `pkcs` DISABLE KEYS */;
REPLACE INTO `pkcs` (`id`, `pkcs_crt`, `pkcs_name`, `cn`, `notbefore`, `notafter`) VALUES
	(1, '/usr/app/vpn/ssl/server/server.pem', '456.pfx', '456', '2020年04日15日10时56分46秒', '2015年04日17日10时56分46秒');
/*!40000 ALTER TABLE `pkcs` ENABLE KEYS */;


-- 导出  表 sslvpn.private_nets 结构
DROP TABLE IF EXISTS `private_nets`;
CREATE TABLE IF NOT EXISTS `private_nets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `net` varchar(30) NOT NULL,
  `net_mask` varchar(30) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `net` (`net`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

-- 正在导出表  sslvpn.private_nets 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `private_nets` DISABLE KEYS */;
REPLACE INTO `private_nets` (`id`, `net`, `net_mask`) VALUES
	(9, '172.16.3.0', '255.255.255.0'),
	(12, '172.16.6.0', '255.255.255.0');
/*!40000 ALTER TABLE `private_nets` ENABLE KEYS */;
...
-- 正在导出表  sslvpn.role 的数据：~5 rows (大约)
/*!40000 ALTER TABLE `role` DISABLE KEYS */;
REPLACE INTO `role` (`id`, `name`, `description`, `createdTime`, `modifiedTime`) VALUES
	(1, '初始化管理员', '初始化管理员', '2010-07-04 15:07:08', '2014-12-16 13:42:52'),
...
-- 正在导出表  sslvpn.role_permission 的数据：~40 rows (大约)
...
-- 正在导出表  sslvpn.route 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `route` DISABLE KEYS */;
/*!40000 ALTER TABLE `route` ENABLE KEYS */;


-- 导出  表 sslvpn.route_user 结构
...
-- 正在导出表  sslvpn.route_user 的数据：~0 rows (大约)
...
-- 正在导出表  sslvpn.safe_policy 的数据：~0 rows (大约)
...
REPLACE INTO `safe_policy` (`id`, `timeout`, `passwordLength`, `errorLimit`, `remoteDisabled`, `macDisabled`, `passwordRules`, `lockTime`) VALUES
	(1, 300, 0, 3, 0, 0, '^[0-9a-zA-Z!$#%@^&amp;amp;amp;amp;amp;amp;amp;*()~_+]{8,20}$', 1);
...
CREATE TABLE IF NOT EXISTS `server` (
  ...
  `server` varchar(50) NOT NULL DEFAULT '10.8.0.0 255.255.255.0',
  `traffic_server` tinyint(4) NOT NULL DEFAULT '1',
  `client_to_client` tinyint(4) NOT NULL DEFAULT '0',
  `duplicate_cn` tinyint(4) NOT NULL DEFAULT '0',
  `keep_alive` int(11) NOT NULL DEFAULT '120',
  ...
  `max_clients` int(11) NOT NULL DEFAULT '2000',
  ...
  `allow_ping_server` tinyint(4) NOT NULL DEFAULT '1',
  `allow_private_net` varchar(50) DEFAULT 'on',
  ...
  `default_domain_suffix` varchar(50) DEFAULT NULL,
  `use_connect_script` tinyint(4) NOT NULL DEFAULT '0',
  `use_disconnect_script` tinyint(4) NOT NULL DEFAULT '0',
...
REPLACE INTO `server` (`id`, `local`, `port`, `protocol`, `server`, `traffic_server`, `client_to_client`, `duplicate_cn`, `keep_alive`, `keep_alive_interval`, `cipher`, `comp_lzo`, `max_clients`, `log_append`, `verb`, `mute`, `dynamic_net`, `static_net`, `group_default_net`, `private_net`, `allow_ping_server`, `allow_private_net`, `client_dns_type`, `client_first_dns`, `client_second_dns`, `default_domain_suffix`, `use_connect_script`, `use_disconnect_script`, `use_learn_address_script`) VALUES
	(1, 'all_interface', 1194, 'tcp', '14.0.0.0 255.255.0.0', 0, 1, 0, 60, 10, 'DES-EDE3-CBC', 1, 2000, 0, 3, 5, '14.0.0.0 255.255.0.0', '10.8.1.0 255.255.255.0', NULL, NULL, 0, '1', 0, '192.168.1.1', '222.46.120.5', 'null', 1, 1, 0);
/*!40000 ALTER TABLE `server` ENABLE KEYS */;


-- 导出  表 sslvpn.server_manager 结构
...
CREATE TABLE IF NOT EXISTS `server_manager` (
  ...
  `server_file` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `cn` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `notbefore` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `notafter` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- 正在导出表  sslvpn.server_manager 的数据：1 rows
/*!40000 ALTER TABLE `server_manager` DISABLE KEYS */;
REPLACE INTO `server_manager` (`id`, `server_name`, `server_file`, `cn`, `notbefore`, `notafter`) VALUES
	(1, 'server.crt', '/usr/app/vpn/ssl/server/4.pem', NULL, NULL, NULL);
...
-- 正在导出表  sslvpn.slog 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `slog` DISABLE KEYS */;
REPLACE INTO `slog` (`ip`, `port`) VALUES
	('192.168.1.8', 514),
	('192.168.4.0', 1514);
...
-- 正在导出表  sslvpn.sys_log 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `sys_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_log` ENABLE KEYS */;


-- 导出  表 sslvpn.terminal 结构
...
-- 正在导出表  sslvpn.terminal 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `user_group` (
  ...
  CONSTRAINT `FK72A9010B499D7EFA` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK72A9010B4A432DCF` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户操作审计表';
...
-- 导出  表 sslvpn.user_private_net 结构
DROP TABLE IF EXISTS `user_private_net`;
CREATE TABLE IF NOT EXISTS `user_private_net` (
  `user_id` int(11) NOT NULL,
  `private_net_id` int(11) NOT NULL,
  PRIMARY KEY (`user_id`,`private_net_id`),
  KEY `FK188A766D40A24624` (`private_net_id`),
  KEY `FK188A766D4E4BB449` (`user_id`),
  KEY `FK188A766D45507B73` (`private_net_id`),
  KEY `FK188A766D6D621AC7` (`private_net_id`),
  KEY `FK188A766DC9DE2D4E` (`user_id`),
  CONSTRAINT `FK188A766D40A24624` FOREIGN KEY (`private_net_id`) REFERENCES `private_nets` (`id`),
  CONSTRAINT `FK188A766D45507B73` FOREIGN KEY (`private_net_id`) REFERENCES `private_nets` (`id`),
  CONSTRAINT `FK188A766D499D7EFA` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK188A766D6D621AC7` FOREIGN KEY (`private_net_id`) REFERENCES `private_nets` (`id`),
  CONSTRAINT `FK188A766DC9DE2D4E` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  sslvpn.user_private_net 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `user_private_net` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_private_net` ENABLE KEYS */;


-- 导出  表 sslvpn.user_route_user 结构
...
-- 正在导出表  sslvpn.user_route_user 的数据：~0 rows (大约)
