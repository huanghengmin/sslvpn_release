 ...
 */
public class DownLoadWin64 extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private Logger logger = Logger.getLogger(DownLoadWin64.class);
...
//        String result = actionBase.actionBegin(request);
        ...
        try {
            ...
            Version av = null;
            String android_version = StringContext.systemPath + "/client/windows/x64" + "/version.xml";
